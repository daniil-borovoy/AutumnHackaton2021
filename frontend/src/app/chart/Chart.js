    ...
    <div className={styles.chart}>
      ...
      <div className={styles.buttons}>
        <div className={styles.chartTypes}>
          <button className={type === 'expenses' ? styles.active : ''} onClick={() => setType('expenses')}>Расходы</button>
          <button className={type === 'stonks' ? styles.active : ''} onClick={() => setType('stonks')}>Доходы</button>
